...
export function buildCssBanner(
  ...
  const themeNotice = options.hasThemeInline
    ? `
 * @theme inline at the end of this file is generated by define-tokens.
 ...
 *   npx define-tokens build ${tokens} ${css}
 *${themeNotice}
 */
`;
}
...
export async function runBuild(options: BuildOptions): Promise<number> {
  ...
  if (!existsSync(paths.tokensPath)) {
    ...
    console.error('Run `npx define-tokens init` first, or pass custom paths.');
    return 1;
  }
